<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="showReviewer" label="审查人" width="110px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="国家" prop="type">
          <el-select v-model="temp.type" class="filter-item" placeholder="请选择国家">
        ...
        <el-form-item label="评论">
          <el-input v-model="temp.remark" :autosize="{ minRows: 2, maxRows: 4}" type="textarea" placeholder="请输入你的感想" />
        </el-form-item>
      </el-form>
    ...
    <el-dialog :visible.sync="dialogPvVisible" title="阅读量统计">
      <el-table :data="pvData" border fit highlight-current-row style="width: 100%">
        <el-table-column prop="key" label="设备类型" />
        <el-table-column prop="pv" label="页面浏览量" />
      </el-table>
...
export default {
  ...
  data() {
    return {
      ...
      pvData: [],
      rules: {
        type: [{ required: true, message: '必须选择国家', trigger: 'change' }],
